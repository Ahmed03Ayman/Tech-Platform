    ...
    <aside class="sidebar">
        <div class="sidebar-header-mobile">
            ...
            <div class="sidebar-menu">
                ...
                <a href="dashbord.php"  class="menu-link active"> الملف الشخصي</a>
                <hr class="divider d-mobile-only">
                <a href="logout.php" class="logout d-mobile-only"> تسجيل الخروج</a>
            </div>
        </div>

         <hr class="divider d-desktop-only">
         <a href="logout.php" class="logout d-desktop-only"> تسجيل الخروج</a>
    </aside>
